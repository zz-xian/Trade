...
public class MyCollectAdapter extends BaseAdapter {
    ...
    public MyCollectAdapter(Context context, List<User> userList, List<Collect> collectList) {
    ...
    public void removeData(Collect collect) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.desc.setText(collectList.get(position).getDesc());
        return convertView;
    }
}
